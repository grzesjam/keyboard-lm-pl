...
| Metric | v0.4 @ 80k | v0.5 @ 50k | v0.5 @ 65k |
|---|---:|---:|---:|
| Top-1 Accuracy | 24.5% | **25.8%** | **25.8%** |
| Top-3 Accuracy | 38.9% | 43.4% | **44.2%** |
| Top-5 Accuracy | 47.3% | **52.6%** | 52.5% |
| KSR | 19.8% | **22.1%** | 21.7% |
| Prefix 2 chars → Top-1 | 77.2% | **78.4%** | 78.3% |
| Prefix 3 chars → Top-1 | 88.2% | **87.9%** | **87.9%** |

v0.5 @ 65k ≈ 1.3 epochs. Training continues to 150k steps (~3 epochs total).
